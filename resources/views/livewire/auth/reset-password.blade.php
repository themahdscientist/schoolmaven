<div class="bg-secondary dark:bg-dark">
    ...
    <div class="flex items-center justify-center py-16">
        <form wire:submit="update"
            ...
            @elseif ($status === Password::INVALID_USER || $status === Password::INVALID_TOKEN || $status)
            <div role="alert"
            ...
            @endif
            <p class="text-sm text-body-dark dark:text-secondary">Enter your registered email, new password, and confirm
                password.</p>
            <div class="relative">
            ...
            <div class="relative">
                <div class="flex mb-2 items-center justify-between">
                    ...
                    <div id="alert-2"
                        class="@error('password_confirmation') flex @else hidden @enderror z-50 items-center ps-1 bg-red-800 rounded-lg text-light dark:bg-dark dark:text-red-400"
                        role="alert">
                        <svg class="flex-shrink-0 w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path
                ...
                <div class="relative">
                    <input type="password" wire:model.blur="password_confirmation" name="password_confirmation"
                        id="password_confirmation"
                        class="bg-secondary placeholder-body-dark/60 text-dark text-sm rounded-lg w-full py-2 px-4 outline-none focus:ring-primary focus:ring-2 caret-primary dark:bg-dark/40 dark:placeholder-secondary/60 dark:text-light"
                        placeholder="••••••••" required autocomplete="password_confirmation">
                    <svg wire:loading wire:target="password_confirmation" role="status" aria-hidden="true"
                        class="dark:text-body-dark text-secondary absolute top-1/4 right-4 h-5 w-5 animate-spin fill-primary"
                        viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
            ...
            <div class="relative">
                <div class="flex mb-2 items-center justify-between">
                    <label for="password" class="block text-sm font-medium text-body-dark dark:text-secondary">Confirm
                        Password</label>
                    <div id="alert-1"
                ...
                <div class="relative">
                    <input type="password" wire:model.blur="password" name="password" id="password"
                        class="bg-secondary placeholder-body-dark/60 text-dark text-sm rounded-lg w-full py-2 px-4 outline-none focus:ring-primary focus:ring-2 caret-primary dark:bg-dark/40 dark:placeholder-secondary/60 dark:text-light"
                        placeholder="••••••••" required autocomplete="new_password">
                    <svg wire:loading wire:target="password" role="status" aria-hidden="true"
                        class="dark:text-body-dark text-secondary absolute top-1/4 right-4 h-5 w-5 animate-spin fill-primary"
                        viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
            ...
            <div class="flex items-center justify-end">
                <button
                    ...
                    type="submit">
                    Save
                    <svg wire:loading wire:target="update" role="status" aria-hidden="true"
