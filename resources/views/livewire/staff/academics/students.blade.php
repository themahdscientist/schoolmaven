<section class="p-4 md:p-8">
    <x-filament::breadcrumbs :breadcrumbs="[
            ...
            route('app.'.session('role').'.academics.students') => 'Students',
        ]" class="mb-4 md:mb-8" />
    {{-- Students table --}}
    <div
            ...
            <div class="fi-ta-empty-state px-6 py-12">
                <div class="fi-ta-empty-state-content mx-auto grid max-w-lg justify-items-center text-center">
                    ...
                    <h4
                        ...
                        No students </h4>
                    <p class="fi-ta-empty-state-description text-sm text-gray-500 dark:text-gray-400 mt-1">Your grades
                        have not been assigned any student yet.</p>
                    <div class="fi-ta-actions flex shrink-0 items-center gap-3 flex-wrap justify-center mt-6"> <button
                            ...
                            </svg> <span class="fi-btn-label"> New Guardian </span> </button> </div>
                </div>
            </div>
            @else
